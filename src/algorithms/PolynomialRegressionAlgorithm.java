...
public final class PolynomialRegressionAlgorithm implements PolynomialRegressionAlgorithmInterface {
     ...
     */
    @Override
    public final SimpleMatrix regress(RegressionData dataPairs, int degree, PostFunctionOperation postOps) {
